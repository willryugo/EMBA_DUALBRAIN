...
const CONCEPT_MAP: Record<string, string[]> = {
  ...
  // 데이터·AI
  "AI": ["인공지능", "머신러닝", "딥러닝", "예측모델", "ML", "생성형"],
  "인공지능": ["AI", "머신러닝", "딥러닝", "ML"],
  "데이터": ["분석", "애널리틱스", "인사이트", "지표", "metrics"],
  "분석": ["애널리틱스", "데이터", "지표", "리포팅"],
  "지표": ["KPI", "메트릭", "데이터", "측정"],
  "생성형": ["생성형AI", "LLM", "챗GPT", "ChatGPT", "프롬프트", "RAG", "에이전트", "할루시네이션"],
  "LLM": ["생성형", "챗GPT", "프롬프트", "RAG", "에이전트"],
  "RAG": ["검색증강", "LLM", "할루시네이션", "생성형"],
  "프롬프트": ["프롬프트엔지니어링", "LLM", "생성형"],

  // 경영과학(운영·최적화)
  "선형계획": ["LP", "최적화", "solver", "제약", "목적함수", "자원배분", "정수계획"],
  "최적화": ["선형계획", "LP", "optimization", "solver", "포트폴리오"],
  "포트폴리오": ["분산투자", "마코위츠", "자산배분", "리스크", "효율적프런티어", "최적화"],
  "분산투자": ["포트폴리오", "마코위츠", "리스크", "공분산"],

  // 윤리·거버넌스
  "윤리": ["컴플라이언스", "준법", "지배구조", "내부고발", "투명성", "CSR", "공유가치"],
  "내부고발": ["whistleblowing", "윤리", "보호", "신고", "투명성"],
  "지배구조": ["거버넌스", "이사회", "윤리", "투명성"],
  "CSR": ["사회적책임", "공유가치", "CSV", "이해관계자", "윤리"],
  "공유가치": ["CSV", "CSR", "이해관계자", "포터", "사회적책임"],
  "CSV": ["공유가치", "공유가치창출", "이해관계자", "포터", "CSR"],
...
const DOMAIN_HINTS: Record<Domain, string[]> = {
  ...
  "운영·SCM": ["운영", "재고", "공급망", "물류", "발주", "신문판매원", "리드타임", "조달", "생산", "선형계획", "최적화", "포트폴리오", "LP", "다이어트", "스케줄링"],
  "재무·회계": ["재무", "회계", "현금", "매출", "이익", "운전자본", "예산", "재무제표", "감사", "원가", "BS", "PL", "CF"],
  "조직·HR": ["조직", "HR", "인사", "승진", "이직", "퇴사", "채용", "리더십", "동기", "사기", "성과급", "면담", "갈등", "문화", "팀", "평가", "다양성", "편견"],
  "데이터·AI": ["데이터", "분석", "AI", "예측", "머신러닝", "지표", "KPI", "딥러닝", "생성형", "LLM", "RAG", "프롬프트", "챗GPT"],
  "윤리·거버넌스": ["윤리", "준법", "컴플라이언스", "지배구조", "내부고발", "투명성", "감사", "CSR", "CSV", "공유가치", "이해관계자"],
};
